...
__C.YOLO.GPUVISIBLE='1'


# Train options
__C.TRAIN                       = edict()

__C.TRAIN.ANNOT_PATH = "data/dataset/coco_train2017_new.txt"

__C.TRAIN.BATCH_SIZE            = 32
__C.TRAIN.SECONDBATCH_SIZE = 4
...
__C.TRAIN.num_gpu = 2
__C.TRAIN.tmp_epoch = 1
__C.TRAIN.ckpt_place = 'checkpoint'
...
__C.TEST.ANNOT_PATH = 'data/dataset/coco_val2017_new.txt'
